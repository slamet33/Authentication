...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/slametnoble/Authentication'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'slametnoble' => 'slametngeblog@gmail.com' }
  s.source           = { :git => 'https://github.com/slametnoble/Authentication.git', :tag => s.version.to_s }
